...
export default function Chat() {
  ...
  const createNewConversation = async () => {
    const welcome = {
      role: 'assistant',
      content: `Hello! I'm TripSync AI, your personal travel planner. 🌍\n\nTell me your destination, dates, and budget — I'll craft a complete itinerary with real hotel and restaurant recommendations!`,
  ...
  return (
    <AppShell user={user}>
      <div className="h-full flex overflow-hidden">
        {/* Chat history panel */}
        <div className="hidden md:flex md:w-56 flex-shrink-0 border-r border-border bg-sidebar flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-2 space-y-0.5">
            {conversations.length === 0 ? (
              ...
              <div key={conv.id} onClick={() => selectConversation(conv)}
                className={cn('group flex items-center gap-2 px-2.5 py-2 rounded-lg cursor-pointer transition-all text-xs',
